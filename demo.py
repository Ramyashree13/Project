...
from tkinnter import messagebox
...
def prescription():
    ...
    global medicine_name=StringVar()
    global mg=IntegerVar()
    global timings=IntegerVar()
...
def login_page():
    ...
    c1.pack()
    image1=PhotoImage(file="C:\\Users\\lenovo\\Documents\\python project\\globe.png")
